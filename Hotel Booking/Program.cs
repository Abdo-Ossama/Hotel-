...
builder.Services.AddScoped<IRepository<CouponUsage>, Repository<CouponUsage>>();
...
builder.Services.AddScoped<IRepository<BookingRoom>, Repository<BookingRoom>>();
...
{
    var dbInitializer =
        scope.ServiceProvider.GetRequiredService<IDbIntializer>();
